...
//reads and stores the SCF and MP2 energy
        ...
        CC.read_vals("/Users/josemarcmadriaga/Documents/prog_proj/proj_CCSD/Escf.dat", CC.Escf);
        CC.read_vals("/Users/josemarcmadriaga/Documents/prog_proj/proj_CCSD/Emp2.dat", CC.Emp2);
        CC.read_vals("/Users/josemarcmadriaga/Documents/prog_proj/proj_CCSD/Etot.dat", CC.Etot);
        cout << "Escf: ";
        printf("%8.15f\n", CC.Escf);
        cout << "Emp2: ";
        printf("%8.15f\n", CC.Emp2);
...
//Same with the AO coefficients
        ...
        CC.read_txt("/Users/josemarcmadriaga/Documents/prog_proj/proj_CCSD/s.txt", CC.overlap);
        CC.read_txt("/Users/josemarcmadriaga/Documents/prog_proj/proj_CCSD/t.txt",CC.kinetic);
        CC.read_txt("/Users/josemarcmadriaga/Documents/prog_proj/proj_CCSD/v.txt", CC.nuclear);
        CC.read_Matrix("/Users/josemarcmadriaga/Documents/prog_proj/proj_CCSD/AO.dat", CC.AO);
...
//reads and stores the MO two electron integrals in an array 
        ...
        CC.read_twoe("/Users/josemarcmadriaga/Documents/prog_proj/proj_CCSD/MO_eric.dat", CC.MO_eric);
	...
	//cout << CC.gen_Fae(0,0) << endl;	
	//cout << CC.gen_Fmi(0,0) << endl;
	//cout << CC.gen_Fme(0,0) << endl;
	
	CC.up_tai();	

	//cout << CC.gen_Wmnij(0,1,3,0) << endl;	
	//cout << CC.gen_Wabef(1,2,3,0) << endl;
	//cout << CC.gen_Wmbej(7,0,3,4) << endl;

	CC.up_taibj();
	
	cout << "Intial CC energy" << endl;
	cout << CC.CC_energy(CC.t_ai,CC.t_aibj) << endl;
...
//Iteration process of updating the t amplitudes from corresponding intermediates and (effective) taus until the correlation energy converges within a threshold
	...
	for (int i=1; i < maxiter; i++){
		...
		cout << "iteration" << '\t' << i << "CC Energy" << '\t' << new_CCenergy << endl; 
	}	
