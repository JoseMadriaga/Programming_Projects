...
public:
	...
	double gen_taibjck_c(int i, int j, int k, int a, int b, int c);
	double gen_taibjck_d(int i, int j, int k, int a, int b, int c);
	double tc_perabc(int i, int j, int k, int a, int b, int c);
	double td_perabc(int i, int j, int k, int a, int b, int c);
	double tc_perijk(int i, int j, int k, int a, int b, int c);
	double td_perijk(int i, int j, int k, int a, int b, int c);
